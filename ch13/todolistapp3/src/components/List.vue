...
.list-enter, .list-leave-to{opacity:0; transform:translateY(50px)}
</style>
<template>
    <!--
     반복 렌더링하는 요소들은 <transition-group>컴포넌트를 사용해야 한다. 
     이 때, 반드시 key 속성을 부여해야 한다.
     tag 속성: 반복 렌더링되는 요소(li)를 감싸는 요소의 태그명 지정(ul)
    -->
