  ...
  methods:{
    ...
    fetchContacts:function(){
      this.$axios.get(CONF.FETCH, {
        ...
        console.log("fetchContacts error: ", ex)
    ...
    addContact:function(contact){
      ...
      }).catch((ex)=> console.log("addContact failed: ", ex))
    },
    ...
    deleteContact: function(no){
      ...
      }).catch((ex)=>console.log("deleteContact failed: ", ex))
    },
    updatePhoto: function(no, file){
      ...
      }).catch((ex)=>console.log("updatePhoto failed: ", ex))
    }
  },
